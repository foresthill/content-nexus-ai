...
export default function HomePage() {
  ...
  const features = [
    {
      name: 'コンテンツ管理',
      description: 'ブログ記事やアフィリエイトコンテンツを簡単に作成・管理できます。',
      icon: (
    ...
    {
      name: '動画管理',
      description: 'ショート動画や長尺動画をアップロードし、効果的に活用できます。',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    {
      name: 'パフォーマンス分析',
      description: '視聴数やエンゲージメント、コンバージョンなどの詳細な分析が可能です。',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    {
      name: 'コメント管理',
      description: 'ユーザーからのコメントを一箇所で管理し、コミュニケーションを促進します。',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">ContentNexus</span>
            <span className="block text-indigo-600 mt-1">マーケティングプラットフォーム</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            コンテンツ作成から分析までをシームレスに管理し、マーケティング効果を最大化します。
          </p>
        </div>
          ...
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            {features.map((feature) => (
              <Link 
                key={feature.name} 
                href={feature.href}
                className="group relative bg-white p-6 focus:outline-none rounded-lg border border-gray-200 hover:border-indigo-500 hover:shadow-lg transition-all duration-200"
              >
                <dt>
                  <div className="absolute flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white group-hover:bg-indigo-600">
                    {feature.icon}
                  </div>
